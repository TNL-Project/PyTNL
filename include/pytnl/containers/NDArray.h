...
export_NDArray( nb::module_& m, const char* name )
{
   ...
   // ConstNDArrayView can still be mutated through a writable view created
   // from the same pointer. Prefer DLPack (`__dlpack__`) for interop that
   // preserves lifetime and const semantics.
