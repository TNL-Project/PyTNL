...
public:
   ...
   PYBIND11_TYPE_CASTER( ArrayType,
                         _( "Tuple[" ) + value_conv::name
                            + _< false >( _( "" ), _( "[" ) + _< ArrayType::getSize() >() + _( "]" ) ) + _( "]" ) );
   ...
   {
      // we don't use StdArrayCaster here because we want to convert Python
      // tuples, not lists
...
struct type_caster< TNL::Containers::StaticArray< Size, T > > : _tnl_tuple_caster< TNL::Containers::StaticArray< Size, T > >
{};

template< typename T, int Size >
struct type_caster< TNL::Containers::StaticVector< Size, T > > : _tnl_tuple_caster< TNL::Containers::StaticVector< Size, T > >
{};
